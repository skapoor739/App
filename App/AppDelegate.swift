...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let leftVC = storyboard.instantiateViewControllerWithIdentifier("LeftMenuVC")
        let mainVC = storyboard.instantiateViewControllerWithIdentifier("MainVC") as! ViewController
        let slideMenu = SlideMenuController(mainViewController: mainVC, leftMenuViewController: leftVC)
